...
export function LeadsTable({
  ...
  // Intro-sourced live transfers count for the empty state (P1: only when needed)
  const shouldFetchHdStats = !isLoading && leads.length === 0 && !search && !statusFilter;
  const { data: hdStats } = useQuery({
    queryKey: ["intro-transfers-count", userOrg?.orgId],
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-xl border border-dashed border-zinc-700 bg-zinc-900/30 p-12 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-2 max-w-md mx-auto">
            Upload your own leads and unlock live transfers at a reduced rate — up to 40% less than Intro-sourced leads.
          </p>
          {onUploadClick && (
